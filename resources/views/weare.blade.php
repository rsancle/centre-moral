...
<div class="body_teatre">
      ...
      <div class="">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item-weare">
            <a class="nav-link" id="history-tab" data-toggle="tab" href="#history" role="tab" aria-controls="history" aria-selected="true">Història</a>
          </li>
          <li class="nav-item-weare">
            <a class="nav-link" id="estel-tab" data-toggle="tab" href="#estel" role="tab" aria-controls="estel" aria-selected="false">L'estel de natzaret</a>
          </li>
          <li class="nav-item-weare">
            <a class="nav-link" id="coral-tab" data-toggle="tab" href="#coral" role="tab" aria-controls="coral" aria-selected="false">Cant Coral</a>
          </li>
          <li class="nav-item-weare">
            <a class="nav-link" id="esbart-tab" data-toggle="tab" href="#esbart" role="tab" aria-controls="esbart" aria-selected="false">Esbart Montseny</a>
          </li>
          <li class="nav-item-weare">
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane" id="estel" role="tabpanel" aria-labelledby="estel-tab">
          ...
          <div class="col-lg-12 margin_10">
            ...
            <div class="col-lg-6">
              ...
              <div class="section_1_teatre_text">
                ...
                <h4><b>Història de L’Estel de Natzaret</b></h4>
                El text de L’Estel reuneix unes característiques que el fan apte per un ventall de públic més ampli que no només l’infantil. Hi ha gresca entre dimonis i pastors, naturalment; hi ha broma innocent de paraula i d’acció, però també hi trobem la lluita dialèctica entre Satanàs i Sant Miquel, i l’argument de la paràbola del fill pròdig que hi dóna el to d’humanitat en un terme força just. L’Estel de Natzaret ha estat i és encara una gran escola de teatre, perquè és un espectacle complet.

                <a class="button_activity border_ac center" target="_blank" href="/images/weare/historia_estel_centre.pdf">Llegir més...</a>
    ...
    <div class="tab-pane" id="coral" role="tabpanel" aria-labelledby="coral-tab">
    ...
    <div class="tab-pane" id="esbart" role="tabpanel" aria-labelledby="esbart-tab">
    ...
    <div class="tab-pane" id="junta" role="tabpanel" aria-labelledby="junta-tab">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="col-lg-6 center">
              <a class="button_activity border_ac center" target="_blank" href="/images/weare/reglament_intern_del_centre.pdf">Reglament de Règim Intern</a>
            </div>
            <div class="col-lg-6 center">
              <a class="button_activity border_ac center" target="_blank" href="/images/weare/estatus_del_centre.pdf">Estatuts del Centre</a>
            </div>
    ...
    <div class="tab-pane" id="contacte" role="tabpanel" aria-labelledby="contacte-tab">
